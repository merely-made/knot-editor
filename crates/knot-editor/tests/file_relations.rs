...
use knot_editor::{
    DirectorySource, IgnorePolicy, KnotFileCatalog, KnotRelationEndpointV1, KnotRelationPositionV1,
    KnotSyncEvent, KnotSyncFileStore, KnotVault,
};
...
async fn catalog_capture_keeps_disk_authority_and_historical_relation_after_reopen() {
    ...
    let endpoint = |start, end, quote: &str| KnotRelationEndpointV1 {
